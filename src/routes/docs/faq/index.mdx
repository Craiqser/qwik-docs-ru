...
Мы разработали Qwik так, чтобы он был [чрезвычайно прост в освоении](./../cheat/qwik-react/index.mdx) и был знаком React-разработчикам, создание компонентов практически идентично, а маршрутизация вдохновлена Nextjs и другими фреймворками.
