...
[Auth.js](https://authjs.dev/) позволяет разработчикам настроить процесс аутентификации в вашем веб-приложении. Эта библиотека поддерживает широкий спектр [провайдеров аутентификации](https://authjs.dev/reference/core/providers) и другие [опции](https://next-auth.js.org/configuration/options#options). Имейте в виду, что библиотека Auth.js все ещё находится на стадии pre-1.0 и может иметь ошибки.
