...
В производственной среде установка переменных на стороне сервера зависит от конкретной платформы. Большинство платформ позволяют устанавливать переменные окружения из своей панели управления или CLI. Пожалуйста, обратитесь к документации по вашей платформе для получения дополнительной информации.
