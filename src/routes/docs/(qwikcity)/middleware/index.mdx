...
API, специфичный для платформы развертывания (Azure, Cloudflare, Deno, Google Cloud Run, Netlify, Node.js, Vercel и т. д.).
...
Получите объект HTTP-запроса. Полезно для получения данных запроса, таких как заголовки.
