...
Пожалуйста, обратитесь к [документации](/qwikcity/integrations/styled-vanilla-extract/index.mdx) для получения дополнительной информации.
...
Чтобы использовать Tailwind в своём приложении, вы можете добавить его с помощью нашей встроенной интеграции:

```shell
npm run qwik add tailwind
```

Ознакомьтесь с нашей [документацией по интеграции](../../../qwikcity/integrations/tailwind) для получения дополнительной информации.
