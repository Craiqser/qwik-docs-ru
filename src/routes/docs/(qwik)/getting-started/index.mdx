...
<CodeSandbox src="/src/routes/demo/getting-started/01-route/index.tsx" sandboxStyle={{ height: '6em' }}>
```tsx
import { component$ } from '@builder.io/qwik';
...
<CodeSandbox src="/src/routes/demo/getting-started/02-loading-data/index.tsx" sandboxStyle={{ height: '6em' }}>
```tsx
import { component$ } from '@builder.io/qwik';
import { routeLoader$ } from '@builder.io/qwik-city';
...
<CodeSandbox src="/src/routes/demo/getting-started/03-posting-data/index.tsx" sandboxStyle={{ height: '8em' }}>
```tsx
...
<CodeSandbox src="/src/routes/demo/getting-started/04-state/index.tsx" sandboxStyle={{ height: '10em' }}>
```tsx
/* eslint-disable no-console */
...
<CodeSandbox src="/src/routes/demo/getting-started/05-tasks/index.tsx" sandboxStyle={{ height: '10em' }}>
```tsx
/* eslint-disable no-console */
import { component$, useSignal, useTask$ } from '@builder.io/qwik';
import {
...
<CodeSandbox src="/src/routes/demo/getting-started/06-styling/index.tsx" sandboxStyle={{ height: '10em' }}>
```tsx
/* eslint-disable no-console */
import {
  component$,
