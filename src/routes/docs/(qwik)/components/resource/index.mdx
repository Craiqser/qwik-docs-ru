...
> Как и все `use-`хуки, он должен вызываться в контексте [`component$()`](/docs/(qwik)/components/overview/index.mdx#component), при этом применяются все правила [использования use-методов](/docs/(qwik)/components/tasks/index.mdx).
>
