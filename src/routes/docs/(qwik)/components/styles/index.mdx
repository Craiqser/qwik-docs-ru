...
Пожалуйста, обратитесь к [документации](/docs/integrations/styled-vanilla-extract/index.mdx) для получения дополнительной информации.
...
Чтобы использовать локальные стили CSS, вы можете воспользоваться хуком `useStyleScoped$()`, экспортированным из `@builder.io/qwik`.
...
Ознакомьтесь с нашей [документацией по интеграции](/docs/integrations/tailwind/index.mdx) для получения дополнительной информации.
...
Ознакомьтесь с нашей [документацией по интеграции](/docs/integrations/postcss/index.mdx) для получения дополнительной информации.
