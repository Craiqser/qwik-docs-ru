...
⚠️ При использовании аннотаций типов необходимо обернуть тип события в `PropFunction`, чтобы сообщить TypeScript, что функция не может быть вызвана синхронно.
