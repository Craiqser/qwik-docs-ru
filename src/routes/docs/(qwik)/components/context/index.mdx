...
- Как и все [`use-хуки`](/docs/(qwik)/components/tasks/index.mdx#правила-use-хуков), он используется в корне [`component$()`](/docs/(qwik)/components/overview/index.mdx#component).
