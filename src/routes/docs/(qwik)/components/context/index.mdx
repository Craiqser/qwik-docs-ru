...
- Как и все [`use-методы`](/docs/(qwik)/components/tasks/index.mdx#use-method-rules), он используется в корне [`component$()`](/docs/(qwik)/components/overview/index.mdx#component).
