...
Компоненты Qwik должны быть знакомы многим UI-разработчикам:
...
Узнайте больше о ключевых концепциях написания [компонентов Qwik](../concepts/components/index.mdx).
