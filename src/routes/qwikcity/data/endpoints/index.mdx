...
Для использования полученных в конечной точке данных вы можете использовать встроенный хук `useResource$` или компонент `<Resource />`, как описано [здесь](../../../../routes/docs/components/resource/index.mdx).
