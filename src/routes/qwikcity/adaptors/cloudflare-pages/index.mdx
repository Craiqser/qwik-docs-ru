...
После установки интеграции с помощью `npm run qwik add` проект готов к развёртыванию в Cloudflare Pages. Однако вам нужно будет создать репозиторий git и поместить в него код.
