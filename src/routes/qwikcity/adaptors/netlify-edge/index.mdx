...
После установки интеграции с помощью `npm run qwik add` проект готов к развёртыванию в Netlify. Однако вам нужно будет создать репозиторий git и отправить в него код.
