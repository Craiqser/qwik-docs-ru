---
title: Qwik City и Vanilla-Extract
...
Пожалуйста, обратитесь к [нашей официальной документации по интеграции](/qwikcity/integrations/styled-vanilla-extract/index.mdx) для получения дополнительной информации.
