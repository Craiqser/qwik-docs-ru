...
2. Использование функции [`useContent()`](/qwikcity/api/index.mdx#usecontent) для получения структуры меню в шаблоне для рендеринга. [Подробнее здесь](/qwikcity/api/index.mdx#usecontent).
