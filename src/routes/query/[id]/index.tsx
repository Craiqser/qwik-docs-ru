...
export default component$(() => {
  ...
  return (
    <div>
      <h1 class="text-3xl">Запрос: {queryData.query}</h1>
      <h2 class="text-3xl">Модель: {queryData.model}</h2>
      <div>
